    ...
    <div className="w-full max-w-md bg-surface border border-border p-8 rounded-lg shadow-card text-text-primary my-8">
      ...
      <div className="flex flex-col gap-3">
        <button
          ...
          className="flex items-center justify-center gap-3 w-full py-2.5 bg-white border border-gray-200 rounded-md hover:bg-gray-50 transition-colors text-gray-800 font-medium shadow-sm"
        >
